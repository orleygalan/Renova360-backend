...
require '../models/comentario_servicio_molde.php';

class Comentario_servicio_controlador
{
    private $comentario_molde;

    public function __construct()
    {
        $this->comentario_molde = new Comentario_servicio_molde();
    }

    public function agregar_comentario_controlador($usuario_ID, $servicio_ID, $comentario)
    {
        if ($this->comentario_molde->agregar_comentario($usuario_ID, $servicio_ID, $comentario)) {
            echo json_encode([
                'status' => 'ok',
